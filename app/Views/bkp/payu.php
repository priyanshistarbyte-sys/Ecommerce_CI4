<link rel="stylesheet" href="<?= base_url("assets/website/css/checkout.css") ?>">
<?php if (@$hash) { ?>
...
<?php } else { ?>
    ...
    <div id="container" style="margin-top:50px;">
            ...
            <div class="_1fhgRH mb-70">
                <div class="card pt-3">
                    <div class="progress-box">
                        <div class="steps false svelte-idjy9v">
                            <div class="steps-inner svelte-idjy9v">
                                <div class="step step-mobile  svelte-idjy9v">
                                    <div class="info-wrap svelte-idjy9v"><span class="circle-box  merchant-color merchant-border svelte-idjy9v">1</span> <span class="title  merchant-color svelte-idjy9v">Address</span></div>
                                </div>
                                <div class="step step-address svelte-idjy9v">
                                    <div class="info-wrap svelte-idjy9v"><span class="circle-box  svelte-idjy9v">2</span> <span class="title  svelte-idjy9v">Order Summary</span></div>
                                </div>
                                <div class="step hide-pseudo active pointer  step-pay  svelte-idjy9v">
                                    <div class="info-wrap svelte-idjy9v"><span class="circle-box  svelte-idjy9v">3</span> <span class="title  svelte-idjy9v">Payment</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="py-2 px-3 payment-method-list">
                    ...
                    <?php if (in_array("gpay", @$payment_method)) { ?>
                        <div class="form-check available-method <?= @$active; ?>" pay-type="gpay">
                            <label class="form-check-label">
                                ...
                                <span class="unaviablee">G Pay</span>
                            </label>
                        </div>
                    <?php @$active ? $active = "" : "";
                    } ?>
                    ...
                    <?php if (in_array("paytm", @$payment_method)) { ?>
                        ...
                        <div class="form-check available-method <?= @$active; ?>" pay-type="paytm">
                            <label class="form-check-label">
                    ...
                    <?php if (in_array("bhim_upi", @$payment_method)) { ?>
                        <div class="form-check available-method <?= @$active; ?>" pay-type="bhim_upi">
                            <label class="form-check-label">
                    ...
                    <?php if (in_array("whatspp_pay", @$payment_method)) { ?>
                        <div class="form-check available-method <?= @$active; ?>" pay-type="whatspp_pay">
                            <label class="form-check-label">
                                <img src="<?= base_url(); ?>assets/website/images/whatspp_pay.svg" class="pay-logo" alt="button">
                                <span class="unaviablee">WhatsppPay</span>
                            </label>
                        </div>
                    <?php } ?>
                ...
                <div class="card px-3 py-4 mb-2" id="price-detail">
                    ...
                    <div class="price-detail-div mt-2">
                        ...
                        <div class="product-price-list mt-3 pt-3 total">
                            ...
                            <span class="data selling_price">&#8377;456</span>
                        </div>
                    </div>
                    <div class="order-summary-container delivery-estimate svelte-v5959g"><img src="https://pdp.gokwik.co/assets/icons/express.svg" alt="shipping-icon" class="svelte-v5959g">
                        <p class="svelte-v5959g">Earliest Delivery by Next 2-3 Days</p>
                    </div>
                </div>
                ...
                <div class="svg-100">
                    <svg width="360" height="85" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <defs>
                            ...
                            <path d="M19.723 7.351c-1.64 0-4.592-.417-7.544-2.922C9.817 6.934 6.668 7.35 4.83 7.35c-.918 0-1.509-.104-1.509-.104v5.38c0 11.272 8.858 14.347 8.858 14.347s8.857-3.075 8.857-14.348v-5.38s-.492.105-1.313.105z" id="a" />
                ...
                <form method="post" id="paymentForm">
                    <div class="button-container flex p-3 bg-white">
                        <!-- <a class="btn btn-dark save-cart" href="#" onclick="payNow()">
                    PayNow &nbsp;
                    <span class="price-btn"></span>
                    <img src="https://pdp.gokwik.co/assets/icons/arrow-right.png" alt="gokwik-icon" class="svelte-1gamriy">
                </a> -->
                        <input type="hidden" id="price" name="price" value="">
                        <input type="hidden" id="product_name" name="product_name" value="">

                        <button class="btn btn-dark save-cart" value="submit" name="submit" type="submit">
                            PayNow &nbsp;
                            <span class="price-btn"></span>
                            <img src="https://pdp.gokwik.co/assets/icons/arrow-right.png" alt="gokwik-icon" class="svelte-1gamriy">
                        </button>
        ...
        <script>
            ...
            //         case 'phonepe':
            //             redirect_url = "phonepe://pay?pa=" + upiId + "&pn=" + site_name + "&am=" + amt + "&tr=&mc=8999&cu=INR&tn=" + txn_id;
            //             break;

            //         case 'paytm':
            //             redirect_url = "paytmmp://pay?pa=" + upiId + "&pn=" + site_name + "&am=" + amt + "&tr=&mc=8999&cu=INR&tn=" + txn_id;
            //             break;

            //         case 'bhim_upi':
            //             redirect_url = "bhim://pay?pa=" + upiId + "&pn=" + site_name + "&am=" + amt + "&tr=&mc=8999&cu=INR&tn=" + txn_id;
            //             break;

            //         case 'whatspp_pay':
            //             redirect_url = "whatsapp://pay?pa=" + upiId + "&pn=" + site_name + "&am=" + amt + "&tr=&mc=8999&cu=INR&tn=" + txn_id;
            //             break;
